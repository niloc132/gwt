...
public class JsEnumTest extends GWTTestCase {
    @Override
    ...
    @Override
    protected native void gwtSetUp() throws Exception /*-{
        $wnd.test = {};
        $wnd.test.NativeEnum = {
          OK: 'Ok',
          CANCEL: 'Cancel'
...
//    public void testStringNativeJsEnum() {
...
//            assertTrue(ignored.getMessage().contains("java.lang.Enum"));
//        }
////
////        assertThrowsClassCastException(
////                () -> {
...
//        assertTrue((Object) v != ONE_DOUBLE);//TODO decide if we want this
...
//        assertFalse(v.equals(ONE_DOUBLE));//TODO decide if we want this
//        assertFalse(PlainJsEnum.ZERO.equals(OtherPlainJsEnum.NONE));//TODO decide if we want this
...
//        assertFalse(o.equals(ONE_DOUBLE));//TODO decide if we want this
...
//        assertFalse(v instanceof Enum);//TODO seems like a weird restriction...
...
//            fail("expected CCE");
//        } catch (ClassCastException ignored) {
//            assertTrue(ignored.getMessage().contains("java.lang.Double"));
//        }
...
//        assertFalse(v instanceof Enum);
//        assertTrue(v instanceof BooleanJsEnum);//TODO ???
...
//    public void testJsEnumClassInitialization() {
...
//    public void testNativeEnumClassInitialization() {
...
//    }
    ...
    public void testDoNotAutoboxJsEnum() {
    ...
    public void testUnckeckedCastJsEnum() {
...
//    public void testAutoBoxing_relationalOperations() {
...
//    public void testAutoBoxing_specialMethods() {
...
//    public void testAutoBoxing_intersectionCasts() {
...
//    public void testAutoBoxing_typeInference() {
...
//    public void testAutoBoxing_parameterizedLambda() {
//
